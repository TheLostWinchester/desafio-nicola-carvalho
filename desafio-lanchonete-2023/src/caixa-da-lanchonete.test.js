...
describe('CaixaDaLanchonete', () => {
    ...
    test.each([
        ...
        ['dinheiro', 'R$ 13,96', ['suco,1', 'queijo,1', 'sanduiche,1']],
    ...
    test.each([
        ['combo1','debito','R$ 11,50',['combo1,1','queijo,1']],
        ['combo2','debito','R$ 9,00',['combo2,1','chantily,1']],
        ['combo2','debito','R$ 9,50',['combo2,1','queijo,1']]
    ])('compra %p em %p deve resultar em %p', (_, formaDePagamento, resultadoEsperado, itens) =>
        validaTeste(formaDePagamento, resultadoEsperado, itens));
